...
public class ResultadoConsulta  implements java.io.Serializable {
    ...
    /**
     * Gets the referenciaFactura value for this ResultadoConsulta.
     * 
    ...
    /**
     * Sets the referenciaFactura value for this ResultadoConsulta.
     * 
    ...
    /**
     * Gets the totalPagar value for this ResultadoConsulta.
     * 
     * @return totalPagar
     */
    ...
    /**
     * Sets the totalPagar value for this ResultadoConsulta.
     * 
     * @param totalPagar
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.servicios.co/pagos/schemas", "ResultadoConsulta"));
